...
<section class="form-box py-4 py-lg-5" style="background-image: url('<?php echo $form_bg; ?>')">
    <div class="container my-lg-5">
        <div class="position-relative">
            ...
            <h2 class="subtitle chakra-petch-font text-center standard-title-4 fw-bolder mb-3 mb-lg-5 text-white">Wyślij zapytanie</h2>
        </div>
        <div class="form-box--cnt">
            <!-- Contact form -->
            <?php echo apply_shortcodes('[contact-form-7 id="ec2b6ee" title="Formularz 1"]'); ?>
        </div>
    </div>
</section>